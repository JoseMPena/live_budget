defmodule LiveBudget.CategoriesTest do
  ...
  describe "categories" do
    ...
    import LiveBudget.CategoriesFixtures

    @invalid_attrs %{code: nil, name: nil, description: nil, icon: nil}
    ...
    test "create_category/1 with valid data creates a category" do
      valid_attrs = %{code: "some code", name: "some name", description: "some description", icon: "some icon"}
    ...
    test "update_category/2 with valid data updates the category" do
      category = category_fixture()
      update_attrs = %{code: "some updated code", name: "some updated name", description: "some updated description", icon: "some updated icon"}
